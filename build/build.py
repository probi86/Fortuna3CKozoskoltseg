...
META = [
 ...
 ("Salubritate",    ("Salubritate","szemétszállítás","pers")),
 ("Futes DIF",      ("Încălzire diferență","fűtés-elszámolás","cpi")),
 ("Lift",           ("Lift","","apt")),
 ("Administrare",   ("Administrare","","apt")),
 ("Stat de plata",  ("Stat de plată","alkalmazottak bére","apt")),
 ...
 ("Contambees",     ("Contambees","könyvelés","apt")),
 ("Bariera",        ("Barieră","sorompó","apt")),
